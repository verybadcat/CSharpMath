...
namespace CSharpMath.Ios.Example {
  ...
  public class AppDelegate : UIApplicationDelegate {
    public override bool FinishedLaunching
      ...
      Window = new UIWindow { RootViewController = new IosMathViewController() };
      return true;
    }
    ...
    public override void DidEnterBackground(UIApplication application) {
      ...
      // If your application supports background exection this method
      // is called instead of WillTerminate when the user quits.
    }
