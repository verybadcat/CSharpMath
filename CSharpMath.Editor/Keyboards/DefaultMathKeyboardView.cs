      ...
      new MathKeyboard<TButton, TLayout>(layoutCtor,
        registerPressed,
          ...
          null,
            ctor(new RectangleF(0, 135, 50, 45), "Exponent", 18, ToBeReplacedWithImage, DefaultShadow, ToBeReplacedWithImage, null),
          null,
            ctor(new RectangleF(100, 135, 50, 45), "sqrt", DefaultFontSize, ToBeReplacedWithImage, DefaultShadow, ToBeReplacedWithImage, null),
            ctor(new RectangleF(150, 135, 49, 45), "root", DefaultFontSize, ToBeReplacedWithImage, DefaultShadow, ToBeReplacedWithImage, DefaultDisabled),
          null,
                      new[] {
              ctor(new RectangleF(0, 0, 50, 45), "x", DefaultFontSize, DefaultTitle, DefaultShadow, DefaultHighlight, null),
              ctor(new RectangleF(0, 45, 50, 45), "y", DefaultFontSize, DefaultTitle, DefaultShadow, DefaultHighlight, null),
          ...
          new[]{
            ...
            ctor(new RectangleF(50, 135, 50, 45), "sub", DefaultFontSize, ToBeReplacedWithImage, DefaultShadow, ToBeReplacedWithImage,null),
            ...
            ctor(new RectangleF(150, 90, 49, 45), "log_", DefaultFontSize, DefaultTitle, DefaultShadow, DefaultHighlight, null),
          },
                 null,
                 null,
                 null,
                 ...
                 null,
                 null,
                 ctor(new RectangleF(249, 0, 71, 45), "Backspace", DefaultFontSize, ToBeReplacedWithImage, DefaultShadow, ToBeReplacedWithImage, null),
                 ctor(new RectangleF(249, 135, 71, 45), "Dismiss", DefaultFontSize, ToBeReplacedWithImage, DefaultTitle, ToBeReplacedWithImage, null),
        ...
        new MathKeyboard<TButton, TLayout>(layoutCtor,
          ...
          null,
          null,
          ctor(new RectangleF(0, 90, 98, 45), "Shift", 27, ToBeReplacedWithImage, DefaultShadow, ToBeReplacedWithImage, null),
          null,
          null,
          null,
          null,
          ...
          ctor(new RectangleF(272, 90, 48, 45), "Backspace", 27, ToBeReplacedWithImage, DefaultShadow, ToBeReplacedWithImage, null),
          ctor(new RectangleF(0, 135, 80, 45), "Dismiss", 27, ToBeReplacedWithImage, DefaultShadow, ToBeReplacedWithImage, null),
