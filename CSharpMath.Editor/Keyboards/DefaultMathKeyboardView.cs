...
#warning Replace "Frac" with image
            ctor(new RectangleF(0, 90, 49.5f, 45), "Frac", 18, ToBeReplacedWithImage, DefaultShadow, ToBeReplacedWithImage, null),
...
#warning Replace "Expt" with image
            ctor(new RectangleF(0, 135, 50, 45), "Expt", 18, ToBeReplacedWithImage, DefaultShadow, ToBeReplacedWithImage, null),
            null,
            null,
            null,
            null,
            ...
            null,
            null,
            ctor(new RectangleF(248.5f, 0, 71.5f, 45), "Back", DefaultFontSize, DefaultTitle, DefaultShadow, DefaultHighlight, null),
        ...
        new MathKeyboard<TButton, TLayout>(layoutCtor,
          registerPressed,
            new RectangleF(0, 45, 320, 180),
            ctor(new RectangleF(0, 90, 50, 45), "Frac", 18, ToBeReplacedWithImage, DefaultShadow, ToBeReplacedWithImage, null),
            null,
            null,
            null,
#warning Replace "Expt" with image
      ...
      new MathKeyboard<TButton, TLayout>(layoutCtor,
        registerPressed,
          ...
          null,
            ...
            ctor(new RectangleF(150, 90, 49, 45), "log_", DefaultFontSize, ToBeReplacedWithImage, DefaultShadow, ToBeReplacedWithImage, null),
            null,
            null,
          new[] {
              ctor(new RectangleF(0, 0, 50, 45), "x", DefaultFontSize, DefaultTitle, DefaultShadow, DefaultHighlight, null),
          ...
          new[] {
            ...
            #warning log with base should get its own argument
                 ...
                 null,
                 null,
                 ctor(new RectangleF(249, 0, 71, 45), "Back", DefaultFontSize, ToBeReplacedWithImage, DefaultShadow, ToBeReplacedWithImage, null),
        ...
        new MathKeyboard<TButton, TLayout>(layoutCtor,
          ...
          ctor(new RectangleF(272, 90, 48, 45), "Back", 27, ToBeReplacedWithImage, DefaultShadow, ToBeReplacedWithImage, null),
