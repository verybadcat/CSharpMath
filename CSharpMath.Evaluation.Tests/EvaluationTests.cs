...
namespace CSharpMath.EvaluationTests {
  ...
  public class EvaluationTests {
    ...
    [InlineData(@"a_2", @"a_{2}", @"a_{2}")]
    [InlineData(@"a_2+a_2", @"a_{2}+a_{2}", @"2a_{2}")]
    ...
    [InlineData(@"\mathrm{a^2a^2ab}", @"a^{2}a^{2}\cdot \mathrm{ab}", @"a^{4}\cdot \mathrm{ab}")]
    [InlineData(@"\mathrm{a_2a_2ab}", @"a_{2}a_{2}\mathrm{ab}", @"a_{2}^{2}\cdot \mathrm{ab}")]
    [InlineData(@"\mathrm{a^2_2a_2^2ab}", @"a_{2}^{2}a_{2}^{2}\cdot \mathrm{ab}", @"a_{2}^{4}\cdot \mathrm{ab}")]
    ...
    [InlineData(@"\log_3 x", @"\log _{3}\left( x\right) ", @"\log _{3}\left( x\right) ")]
    ...
    [InlineData(@"\log_3 x^2", @"\log _{3}\left( x^{2}\right) ", @"\log _{3}\left( x^{2}\right) ")]
    ...
    [InlineData(@"\log_3 x^{-1}", @"\log _{3}\left( x^{-1}\right) ", @"\log _{3}\left( \frac{1}{x}\right) ")]
    ...
    [InlineData(@"\log_3^2 x", @"\log _{3}\left( x\right) ^{2}", @"\log _{3}\left( x\right) ^{2}")]
    ...
    [InlineData(@"\log^{-a_2} x", @"\log \left( x\right) ^{-a_{2}}", @"\log \left( x\right) ^{-a_{2}}")]
    ...
    [InlineData(@"\sin a,\cos b^2,\tan c_3,\cot de,\sec 12f,\csc g+h",
      @"\sin \left( a\right) ,\cos \left( b^{2}\right) ,\tan \left( c_{3}\right) ,\cot \left( d\mathrm{e}\right) ,\sec \left( 12f\right) ,\csc \left( g\right) +h")]
    ...
    [InlineData("log(3,alpha)", @"\log _{3}\left( \alpha \right) ")]
    ...
    [InlineData(@"\lim_{x\to0^+}\frac1x+1", @"\lim _{x\rightarrow 0^{+}}\frac{1}{x}+1", @"\infty ")]
    [InlineData(@"\lim_{x\to\infty}\frac1x^2x^2+1", @"\lim _{x\rightarrow \infty }\left( \frac{1}{x}\right) ^{2}x^{2}+1", @"2")]
    [InlineData(@"\lim_{x\to\infty^-}\frac1x^2x^2+1", @"\lim _{x\rightarrow \infty ^{-}}\left( \frac{1}{x}\right) ^{2}x^{2}+1", @"2")]
    [InlineData(@"\lim_{x\to\infty^+}\frac1x^2x^2+1", @"\lim _{x\rightarrow \infty ^{+}}\left( \frac{1}{x}\right) ^{2}x^{2}+1", @"2")]
    ...
    [InlineData(@"\lim_{x\to(y)^+}(x)y+y", @"\lim _{x\rightarrow y^{+}}xy+y", @"y^{2}+y")]
    [InlineData(@"\lim_{x\to(y)^-}(x)y+y", @"\lim _{x\rightarrow y^{-}}xy+y", @"y^{2}+y")]
    [InlineData(@"\lim_{y\to zzz_2}x", @"\lim _{y\rightarrow zzz_{2}}x", @"x")]
    [InlineData(@"\lim_{y\to zzz_2^-}x", @"\lim _{y\rightarrow \left( zzz_{2}\right) ^{-}}x", @"x")]
    [InlineData(@"\lim_{y\to zzz_2^+}x", @"\lim _{y\rightarrow \left( zzz_{2}\right) ^{+}}x", @"x")]
    [InlineData(@"\lim_{xyy\to zzz_2}x", @"\lim _{xyy\rightarrow zzz_{2}}x", @"\lim _{xy^{2}\rightarrow z^{2}\cdot z_{2}}x")]
    [InlineData(@"\lim_{xyy\to zzz_2^-}x", @"\lim _{xyy\rightarrow \left( zzz_{2}\right) ^{-}}x", @"\lim _{xy^{2}\rightarrow \left( z^{2}\cdot z_{2}\right) ^{-}}x")]
    [InlineData(@"\lim_{xyy\to zzz_2^+}x", @"\lim _{xyy\rightarrow \left( zzz_{2}\right) ^{+}}x", @"\lim _{xy^{2}\rightarrow \left( z^{2}\cdot z_{2}\right) ^{+}}x")]
    ...
    [InlineData(@"\int\int\mathrm{d}x\mathrm{d}y", @"\int \int 1\, \mathrm{d}x\, \mathrm{d}y", @"C_{1}+\left( C+x\right) \cdot y")]
    [InlineData(@"(\int\int\mathrm{d}x\mathrm{d}y)", @"\int \int 1\, \mathrm{d}x\, \mathrm{d}y", @"C_{1}+\left( C+x\right) \cdot y")]
    [InlineData(@"\int\int C\mathrm{d}x\mathrm{d}y", @"\int \int C\, \mathrm{d}x\, \mathrm{d}y", @"\left( C_{1}+Cx\right) \cdot y+C_{2}")]
    [InlineData(@"\int\frac\mathrm{d}{\mathrm{d}x}\int C\mathrm{d}x\mathrm{d}y", @"\int \frac{\mathrm{d}}{\mathrm{d}x}\int C\, \mathrm{d}x\, \mathrm{d}y", @"C_{1}+Cy")]
    ...
    [InlineData(@"\int_0^1\mathrm{d}x", @"\int _{0}^{1}1\, \mathrm{d}x", @"1")]
