...
namespace CSharpMath {
  ...
  public partial class EvluationTests {
    ...
    [InlineData(@"2/\frac ab", @"\frac{2}{\frac{a}{b}}", @"\frac{2}{\frac{a}{b}}")]
    ...
    [InlineData(@"\frac0\infty", @"\frac{0}{\infty }", @"\mathrm{NaN}")]
    [InlineData(@"\frac2\infty", @"\frac{2}{\infty }", @"\mathrm{NaN}")]
    [InlineData(@"\frac{-2}\infty", @"\frac{-2}{\infty }", @"\mathrm{NaN}")]
    ...
    [InlineData(@"[1.5,1.5]", @"\left\{ \left[ \frac{3}{2},\frac{3}{2}\right] \right\} ")]
