...
namespace CSharpMath {
  ...
  public partial class EvluationTests {
    ...
    [InlineData(@"\infty+i", @"\infty +i", @"i+\infty ")]
    ...
    [InlineData(@"2\degree^2", @"\left( \frac{2\times \pi }{180}\right) ^2", @"\frac{1}{8100}\times \pi ^2")]
    [InlineData(@"2\degree2", @"\frac{2\times \pi }{180}\times 2", @"\frac{1}{45}\times \pi ")]
    [InlineData(@"1+2\degree^2", @"1+\left( \frac{2\times \pi }{180}\right) ^2", @"1-\frac{-1}{8100}\times \pi ^2")]
    ...
    [InlineData(@"\sqrt[3]2", @"2^{\frac{1}{3}}", @"2^{\frac{1}{3}}")]
    ...
    [InlineData(@"\tan x\%^2", @"\tan \left( \left( \frac{x}{100}\right) ^2\right) ", @"\tan \left( \frac{1}{10000}\times x^2\right) ")]
    ...
    [InlineData(@"\tan^{-1} x\%^2", @"\arctan \left( \left( \frac{x}{100}\right) ^2\right) ", @"\arctan \left( \frac{1}{10000}\times x^2\right) ")]
