...
namespace CSharpMath.EvaluationTests {
  ...
  public class EvaluationTests {
    ...
    [InlineData(@"\bot\nleftrightarrow\top", @"\top \veebar \bot ", @"\top ")]
    [InlineData(@"\top\nleftrightarrow\bot", @"\bot \veebar \top ", @"\top ")]
    ...
    // Test that ∧ binds tighter than ⊻
    [InlineData(@"a\veebar b\land c", @"a\veebar b\wedge c", @"a\veebar b\wedge c")]
    [InlineData(@"a\land b\veebar c", @"a\wedge b\veebar c", @"a\wedge b\veebar c")]
