...
namespace TestHelper {
  ...
  public abstract partial class DiagnosticVerifier {
    ...
    protected void VerifyCSharpDiagnostic
      ...
      VerifyDiagnostics(new[] { source }, LanguageNames.CSharp,
    ...
    protected void VerifyBasicDiagnostic
      (string source, params DiagnosticResult[] expected) =>
      VerifyDiagnostics(new[] { source }, LanguageNames.VisualBasic,
    ...
    protected void VerifyBasicDiagnostic
      (string[] sources, params DiagnosticResult[] expected) =>
      VerifyDiagnostics(sources, LanguageNames.VisualBasic,
        GetBasicDiagnosticAnalyzer(), expected);
    ...
    /// <param name="expected">DiagnosticResults that should appear after the analyzer is run on the sources</param>
    private void VerifyDiagnostics(string[] sources, string language,
      DiagnosticAnalyzer analyzer, params DiagnosticResult[] expected) =>
      VerifyDiagnosticResults(GetSortedDiagnostics(workspace, sources, language, analyzer),
        analyzer, expected);
    ...
    private static void VerifyDiagnosticLocation(
      DiagnosticAnalyzer analyzer, Diagnostic diagnostic, Location actual,
