...
namespace CSharpMath.Core.EditorTests {
  ...
  public class KeyPressTests {
    ...
    [
      ...
      T(@"X_{2_{3}}", K.X, K.Subscript, K.D2, K.Subscript, K.D3),
      ...
      T(@"\log _{3}", K.LogarithmWithBase, K.D3),
      T(@"\lim _{■}", K.LimitWithBase),
      T(@"\lim _{3}", K.LimitWithBase, K.D3),
      T(@"\int ^{2}", K.Integral, K.Power, K.D2),
      T(@"\int ^{2}", K.IntegralUpperLimit, K.D2),
      T(@"\int _{2}", K.Integral, K.Subscript, K.D2),
      T(@"\int _{2}", K.IntegralLowerLimit, K.D2),
      T(@"\int _{2}^{\square }", K.IntegralBothLimits, K.D2),
      T(@"\int ^{\square ^{2}}", K.IntegralUpperLimit, K.Power, K.D2),
      T(@"\int ^{\square _{2}}", K.IntegralUpperLimit, K.Subscript, K.D2),
      T(@"\int _{\square ^{2}}", K.IntegralLowerLimit, K.Power, K.D2),
      T(@"\int _{\square _{2}}", K.IntegralLowerLimit, K.Subscript, K.D2),
      T(@"\sum ^{2}", K.Summation, K.Power, K.D2),
      T(@"\sum ^{2}", K.SummationUpperLimit, K.D2),
      T(@"\sum _{2}", K.Summation, K.Subscript, K.D2),
      T(@"\sum _{2}", K.SummationLowerLimit, K.D2),
      T(@"\sum _{2}^{\square }", K.SummationBothLimits, K.D2),
      T(@"\sum ^{\square ^{2}}", K.SummationUpperLimit, K.Power, K.D2),
      T(@"\sum ^{\square _{2}}", K.SummationUpperLimit, K.Subscript, K.D2),
      T(@"\sum _{\square ^{2}}", K.SummationLowerLimit, K.Power, K.D2),
      T(@"\sum _{\square _{2}}", K.SummationLowerLimit, K.Subscript, K.D2),
      T(@"\prod ^{2}", K.Product, K.Power, K.D2),
      T(@"\prod ^{2}", K.ProductUpperLimit, K.D2),
      T(@"\prod _{2}", K.Product, K.Subscript, K.D2),
      T(@"\prod _{2}", K.ProductLowerLimit, K.D2),
      T(@"\prod _{2}^{\square }", K.ProductBothLimits, K.D2),
      T(@"\prod ^{\square ^{2}}", K.ProductUpperLimit, K.Power, K.D2),
      T(@"\prod ^{\square _{2}}", K.ProductUpperLimit, K.Subscript, K.D2),
      T(@"\prod _{\square ^{2}}", K.ProductLowerLimit, K.Power, K.D2),
      T(@"\prod _{\square _{2}}", K.ProductLowerLimit, K.Subscript, K.D2),
    ]
    ...
    [
      ...
      T(@"\frac{23}{4}_{6}^{5}78", K.Fraction, K.D3, K.Right, K.D4, K.Right, K.Power, K.D5, K.Right, K.Subscript,
      ...
      T(@"\sqrt[23]{4}_{6}^{5}78", K.NthRoot, K.D3, K.Right, K.D4, K.Right, K.Power, K.D5, K.Right, K.Subscript,
        K.D6, K.Right, K.Right, K.Right, K.D7, K.Left, K.Left, K.Left, K.Left, K.Left, K.Left, K.Left, K.Left, K.Left, K.Left,
        K.D2, K.Right, K.Right, K.Right, K.Right, K.Right, K.Right, K.Right, K.Right, K.Right, K.Right, K.D8),
      ...
      T(@"01\sqrt[\square ]{\square }_{\square }^{\square }90", K.D0, K.NthRoot, K.Right, K.Right, K.Power, K.Right,
        K.Subscript, K.Right, K.Right, K.Right, K.D9, K.Left, K.Left, K.Left, K.Left, K.Left, K.Left, K.Left, K.D1,
        K.Right, K.Right, K.Right, K.Right, K.Right, K.Right, K.Right, K.D0),
      T(@"1\left[ 2\right] a_{3}^{4}", K.BothSquareBrackets, K.Right, K.Power, K.D4, K.Left, K.Left, K.Subscript, K.D3, K.Left, K.Left, K.SmallA, K.Left, K.Left, K.Left, K.Left, K.D1, K.Right, K.D2),
      T(@"1\left[ 2\right] a_{3}^{4}", K.BothSquareBrackets, K.Right, K.Power, K.Right, K.Subscript, K.Left, K.Left, K.Left, K.D1, K.Right, K.D2, K.Right, K.SmallA, K.Right, K.D3, K.Right, K.D4),
    ]
    ...
    [
      ...
      T(@"y_{3_{4}}", K.SmallY, K.Subscript, K.D3, K.Subscript, K.Backspace, K.Backspace, K.D4, K.D5, K.Backspace),
    ...
    [
      ...
      T(@"1_{3}", K.D1, K.D2, K.Subscript, K.D3, K.Left, K.Left, K.Backspace),
      T(@"1_{3}^{2}", K.D1, K.D4, K.Subscript, K.D3, K.Left, K.Left, K.Power, K.D2, K.Left, K.Left, K.Left, K.Left, K.Backspace),
      T(@"1_{2}^{3}", K.D1, K.D4, K.Power, K.D3, K.Left, K.Left, K.Subscript, K.D2, K.Left, K.Left, K.Backspace),
      ...
      T(@"■_{5}", K.Subscript, K.D5, K.Left, K.Left, K.Backspace, K.X, K.Left, K.Left, K.Left, K.Backspace),
    ...
    [
      ...
      T(@"\frac{\log _{3}\pi }{■}", K.LogarithmWithBase, K.D3, K.Right, K.SmallPi, K.Slash),
