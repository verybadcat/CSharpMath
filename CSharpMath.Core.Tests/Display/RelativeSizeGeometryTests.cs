...
namespace CSharpMath.Core.DisplayTests {
  public class RelativeSizeGeometryTests {
    ...
    [Theory]
    [InlineData("tiny", .5f)] [InlineData("scriptsize", .7f)] [InlineData("footnotesize", .8f)]
    [InlineData("small", .9f)] [InlineData("normalsize", 1f)] [InlineData("large", 1.2f)]
    [InlineData("Large", 1.44f)] [InlineData("LARGE", 1.728f)] [InlineData("huge", 2.074f)] [InlineData("Huge", 2.488f)]
    ...
    [Fact] public void LargeScriptScalesExactlyOnce() {
