...
namespace CSharpMath.Display.Displays {
  ...
  public class OverOrUnderlineDisplay<TFont, TGlyph> : IDisplay<TFont, TGlyph>
    ...
    public float Ascent => System.Math.Max(LineShiftUp + LineThickness, Inner.Ascent);
    public float Descent => System.Math.Max(-LineShiftUp + LineThickness, Inner.Descent);
