...
namespace CSharpMath.Structures {
  public class AliasDictionary<K, V> : ICollection<KeyValuePair<K, V>>, IDictionary<K, V> {
    readonly Dictionary<K, V> k2v = new Dictionary<K, V>();
    readonly Dictionary<V, K> v2k = new Dictionary<V, K>();
    ...
    public void Add(K mainKey, K aliasKey1, K aliasKey2, K aliasKey3, K aliasKey4,
      K aliasKey5, V value) {
    ...
    public void Add(K mainKey, K aliasKey1, K aliasKey2, K aliasKey3, K aliasKey4,
      K aliasKey5, K aliasKey6, V value) {
    ...
    public void Add(K mainKey, K aliasKey1, K aliasKey2, K aliasKey3, K aliasKey4,
      K aliasKey5, K aliasKey6, K aliasKey7, V value) {
    ...
    public void Add(K mainKey, K aliasKey1, K aliasKey2, K aliasKey3, K aliasKey4,
      K aliasKey5, K aliasKey6, K aliasKey7, K aliasKey8, V value) {
