...
namespace CSharpMath.Editor.Tests {
  ...
  public class KeyPressTests {
    ...
    [
      ...
      T(@"\frac{\square }{\square }", K.Fraction, K.Left, K.Backspace),
      T(@"\sqrt{\square }", K.SquareRoot, K.Left, K.Backspace),
      T(@"\sqrt[\square ]{\square }", K.NthRoot, K.Left, K.Backspace),
      ...
      T(@"", K.Fraction, K.Right, K.Backspace),
      T(@"", K.SquareRoot, K.Right, K.Backspace),
      T(@"", K.NthRoot, K.Right, K.Backspace),
      T(@"", K.Power, K.Right, K.Backspace),
      T(@"", K.Subscript, K.Right, K.Backspace),
      ...
      T(@"", K.Fraction, K.Right, K.Right, K.Backspace),
      T(@"", K.SquareRoot, K.Right, K.Right, K.Backspace),
      T(@"", K.NthRoot, K.Right, K.Right, K.Backspace),
      T(@"", K.Power, K.Right, K.Right, K.Backspace),
      T(@"", K.Subscript, K.Right, K.Right, K.Backspace),
