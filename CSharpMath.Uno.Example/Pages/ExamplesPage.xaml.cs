...
namespace CSharpMath.Uno.Example {
  public partial class ExamplesPage : Page {
    ...
    static ExamplesPage() {
      ...
      labels[0].Background = new SolidColorBrush(Microsoft.UI.Colors.Gray);
      ...
      labels[1].Background = new SolidColorBrush(Microsoft.UI.Colors.Gray);
      ...
      labels[3].Background = new SolidColorBrush(Microsoft.UI.Colors.Gray);
      ...
      labels[6].Background = new SolidColorBrush(Microsoft.UI.Colors.Gray);
      ...
      labels[7].Background = new SolidColorBrush(Microsoft.UI.Colors.Gray);
